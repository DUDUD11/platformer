...
namespace Flat.Graphics
{
    public sealed class Screen : IDisposable
    {
        ...
        public void Present(Sprites sprites, Effect Effect = null)
        {
            this.Present(sprites, Color.Black, _effect : Effect );
        }

        public void Present(Sprites sprites, Color backgroundColor, bool textureFiltering = true,Effect _effect = null)
        {
            if(this.isSet)
            {
            ...
            sprites.Begin(null, textureFiltering, SpriteBlendType.Alpha,_Effect: _effect);
