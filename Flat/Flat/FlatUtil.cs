...
namespace Flat
{
    public static class FlatUtil
    {
        ...
        public static void SetAbsoulteBackBufferSize(GraphicsDeviceManager graphics, int width, int height)
        { 
            graphics.PreferredBackBufferWidth = (int)MathF.Round((float)width);
            graphics.PreferredBackBufferHeight = (int)MathF.Round((float)height);
            graphics.ApplyChanges();
        }
