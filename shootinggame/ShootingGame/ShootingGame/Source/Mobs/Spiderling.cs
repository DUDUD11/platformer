...
namespace ShootingGame
{
    public class Spiderling : Mob
    {
        ...
        public static string Imp3_path = "Sprite\\Imp3";
        public static Vector2 Imp3_dims = new Vector2(30, 30);
        public static float Imp3_speed = 300f;
        public static float Imp3_atkrange = 100f;
        public static float Imp3_atkdamage = 1f;

        public Spiderling(Game1 game, Vector2 init_pos, FlatWorld.Wolrd_layer wolrd_Layer, float aggrodist) 
            : base(game, Imp3_path, init_pos, Imp3_dims, wolrd_Layer, Imp3_speed, aggrodist, Imp3_atkrange, Imp3_atkdamage)
        {
        ...
        public override void AI(Hero hero)
        {
            if (ShorterthanChaseDistance(hero.pos))
            {
                ...
                if (FlatMath.Length(FlatBody.LinearVelocity) < Imp3_speed || FlatMath.Dot(FlatBody.LinearVelocity, dir) < 0)
                {
